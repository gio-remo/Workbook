...
#Don't forget to set your working directory before doing anything else!
#To do so, simply modify the path between "." below to the folder on your computer
#where your dataset is and where you want to save the output of this R session.
#For me, that is:
#setwd("/home/sebastian/github/metrics/tutorials/tutorial_3")
setwd("C:/Users/Kevin/Desktop/metrics/tutorials/tutorial_3")
...
# NB: The "." in "lm(samesex ~ ., ..." means that you are regressing "samesex" on
# all the other variables contained in the dataset, here the ones contained in "exo_vars".
